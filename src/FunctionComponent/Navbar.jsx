        ...
        <>
            <nav className="navbar navbar-expand-lg background sticky-top">
                <div className="container-fluid">
                    <Link className="navbar-brand text-primary fw-bold fs-2" to="#">NewsApp</Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            <li className="nav-item">
                                <Link className="nav-link  active text-dark fw-bold fs-5" aria-current="page" to="/" onClick={() => props.searchNews("")}>All</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link  text-dark fw-bold fs-5" to="/politics" onClick={() => props.searchNews("")}>Politics</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link  text-dark fw-bold fs-5" to="/science" onClick={() => props.searchNews("")}>Science</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link  text-dark fw-bold fs-5" to="/covid" onClick={() => props.searchNews("")}>Covid19</Link>
                            </li>
                            <li className="nav-item dropdown">
                                <Link className="nav-link  text-dark fw-bold fs-5 dropdown-toggle" to="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    Other
                                </Link>
                        ...
                        <form className="d-flex w-50" role="search" onSubmit={(e) => postData(e)}>
                            ...
                            <button className="btn btn-outline-light text-dark fw-bold " type="submit">Search</button>
                        </form>
                    </div>
                </div>
            </nav>
