...
export default class Navbar extends Component {
    ...
    render() {
        return (
            <>
                <nav className="navbar navbar-expand-lg bg-info fw-bold fs-5 sticky-top">
                    <div className="container-fluid">
                        <Link className="navbar-brand text-light fs-2 text-success" to="/">NewsApp</Link>
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <form className="d-flex w-50" role="search" onSubmit={(e) => this.postData(e)}>
                                <input className="form-control me-2" type="search" name='search' id='search' placeholder="Enter Somthing to Search" aria-label="Search" onChange={(e) => this.getData(e)} />
